    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
		  ...
		  //cout << noisy_observations.size()<<endl;
		  //for (int test_ind = 0; test_ind <noisy_observations.size(); ++test_ind){
		  //	cout << noisy_observations[test_ind].id << "\t" << noisy_observations[test_ind].x << "\t" << noisy_observations[test_ind].y<<endl;
		  //}
